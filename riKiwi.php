...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">NeoMEP</a></h1>
</div>
<!--close-Header-part--> 
...
<!--sidebar-menu-->
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-inbox"></i> riKiwi/a>
  <ul>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Retour à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="riKiwi.php" class="current">riKiwi</a> </div>
    <h1>riKiwi</h1>
  </div>
        ...
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#tab1">Informatique</a></li>
              <li><a data-toggle="tab" href="#tab2">Mécanique et Matériaux</a></li>
              <li><a data-toggle="tab" href="#tab3">Environnement</a></li>
			  <li><a data-toggle="tab" href="#tab3">Energies & Procédés</a></li>
			  <li><a data-toggle="tab" href="#tab3">Etudes de Market</a></li>
			  <li><a data-toggle="tab" href="#tab3">Traductions techniques</a></li>
			  <li><a data-toggle="tab" href="#tab3">Data science</a></li>
			  <li><a data-toggle="tab" href="#tab3">Finance et Entrepreunariat</a></li>
			  <li><a data-toggle="tab" href="#tab3">Génie industriel</a></li>
            </ul>
          </div>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> 2015 &copy; NEO MEP. Par Mines Etudes et Projets.</a> </div>
</div>
<!--end-Footer-part-->
