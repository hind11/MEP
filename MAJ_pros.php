...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Retour à l'accueil" class="tip-bottom"><i class="icon-home"></i> Accueil</a> <a href="#" class="tip-bottom">Form elements</a> <a href="#" class="current">Common elements</a> </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select >
                  ...
                  <option>Propale à faire</option>
                  <option>Contre chiffrage demandé</option>
